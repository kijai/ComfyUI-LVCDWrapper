...
def normalization(channels, affine=True):
    """
    Make a standard normalization layer.
    :param channels: number of input channels.
    :return: an nn.Module for normalization.
    """
    return GroupNorm32(32, channels, affine=affine)

def group_normalization(groups, channels, affine=True):
    return GroupNorm(groups, channels, affine=affine)
